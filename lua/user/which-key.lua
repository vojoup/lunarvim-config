...
wk.mappings["l"]["W"] = { "<cmd>Telescope diagnostics<cr>", kind.symbols_outline.File .. "Project diagnostics" }
wk.mappings["l"]["w"] = { "<cmd>Trouble document_diagnostics<cr>", kind.symbols_outline.File .. "Buffer diagnostics" }
...
wk.mappings["s"]["l"] = {
  ...
  ' ' .. kind.cmp_kind.EnumMember .. " Search in current buffer"
}

wk.mappings["y"] = { "<cmd>TroubleToggle<cr>", kind.icons.error .. "Toggle Trouble" }
...
wk.mappings["W"] = {
  name = ' ' .. kind.icons.screen .. " Window Control",
